...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hackathon_emailmessage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('msg_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages_from', to=orm['hackathon.Person'])),
            ('msg_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages_to', to=orm['hackathon.Person'])),
            ('subj', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('needs_send', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('hackathon', ['EmailMessage'])


    def backwards(self, orm):
        
        # Deleting model 'EmailMessage'
        db.delete_table('hackathon_emailmessage')
    ...
    models = {
        ...
        'hackathon.emailmessage': {
            'Meta': {'object_name': 'EmailMessage'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'msg_from': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages_from'", 'to': "orm['hackathon.Person']"}),
            'msg_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages_to'", 'to': "orm['hackathon.Person']"}),
            'needs_send': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'subj': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
