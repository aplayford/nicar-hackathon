...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ProjectStaff', fields ['project', 'team_leader']
        db.delete_unique('hackathon_projectstaff', ['project_id', 'team_leader'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'ProjectStaff', fields ['project', 'team_leader']
        db.create_unique('hackathon_projectstaff', ['project_id', 'team_leader'])
